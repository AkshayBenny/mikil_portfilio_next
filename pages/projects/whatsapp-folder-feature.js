  ...
  return (
    <main className='max-w-[1400px] mx-auto'>
      ...
      <div className='mt-[80px] lg:mt-[180px] px-[40px] lg:px-[164px]'>
        ...
        <div className='mt-16'>
          <p className='text-black opacity-80 font-normal text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 '>
            I combined the information from my market and user research to
            pinpoint a problem to address:
          </p>
          <p className='text-black opacity-80 font-bold text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 '>
