	...
	return (
		<main className='max-w-[1500px] mx-auto'>
			...
			<div className='lg:flex px-[40px] mx-auto lg:px-[124px] items-center flex-row-reverse w-full justify-between gap-12'>
				...
				<div className='space-y-[16px] flex-grow-1 pt-12 lg:pt-0'>
					...
					<div className='pt-[36px]  flex-col lg:flex-row flex items-center gap-2 lg:justify-start justify-center'>
						<p className='text-light-blue font text-sm'>
							Scroll Down
						</p>
						<div>
				...
				<div className='mt-16 space-y-[64px]'>
					<div className='flex flex-col lg:flex-row lg:justify-between'>
						...
						<p className='text-black opacity-80 font-normal text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
							Conducted a user research by interviewing some
							selected participants from different age categories
							to investigate the real world opinions on WhatsApp.
							The main issue highlighted by the users is that
							sometimes they are not able to keep up eith the
							imortant messages.
						</p>
					</div>
					<div className='mt-16'>
            ...
            '
					...
					<div className='flex flex-col lg:flex-row lg:justify-between'>
						...
						<div className='flex flex-col'>
							<p className='text-black opacity-80 font-normal text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
								I looked into the most common chatting app which
								people around me use, which is the Telegram
								messenger app and Signal.
							</p>
							<p className='text-black opacity-80 font-normal text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
								The majority of them no longer use WhatsApp and
								instead use alternative messaging applications.
								Whatsapp is now evolving into a casual mobile
								chatting programme, while other messaging
								services are more socializing networking.
								Additionally, I learn that other applications
								include tools for organising and prioritising
								their chats and messages.
							</p>
						</div>
					</div>
					<div className='flex flex-col lg:flex-row lg:justify-between'>
						...
						<div className='flex flex-col'>
							<p className='text-black opacity-80 font-normal text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
								After the market research I find that the
								whatsapp is missing an effective way to organize
								the chats and messages.
							</p>
						</div>
					</div>
				</div>
			...
			<div className='mt-[80px] lg:mt-[180px] px-[40px] lg:px-[164px]'>
				...
				<div className='mt-16'>
					<p className='text-black opacity-80 font-normal text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
						I combined the information from my market and user
						research to pinpoint a problem to address:
					</p>
					<p className='text-black opacity-80 font-bold text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
						It&apos;s hard to organize and keep up with messages on
						Whatsapp. Also their is chance in missing important
						messages.
					</p>
				</div>
			</div>
			...
			<div className='mt-[80px] lg:mt-[180px] px-[40px] lg:px-[164px]'>
				...
				<div className='mt-16'>
					<p className='text-black opacity-80 font-bold text-lg lg:text-2xl leading-[28px] lg:leading-[40px] tracking-[-0.25px] lg:tracking-normal pt-4 lg:pt-0 max-w-[705px]'>
						I use actions that people are already familiar with
						rather than presenting a brand-new functionality for
						them to understand. To lower cognitive strain, I merged
						the ideas of starring messages and whatsapp group.
					</p>
			...
			<div className='mt-[80px] lg:mt-[180px] px-[40px] lg:px-[164px]'>
				...
				<p className='font-normal text-base leading-[26px] lg:leading-[33px] lg:text-[20px] opacity-[64%] '>
					I started my design process by making low fidelity sketch. I
					took inspiration from the existing WhatsApp interface and
					functionality. I then added a few of my own concepts to
					...
					<div className='lg:flex gap-[30px] space-y-[30px] lg:space-y-0'>
						<div className='w-full'>
							...
							<p className='font-normal text-[18px] lg:text-[24px] leading-[28px] lg:leading-[40px] pt-[30px]'>
								The new folder feature symbol has to be simple
								enough for consumers to comprehend when it was
								introduced. We needed to put this feature in a
								prominent location because it is crucial rather
								than adding more navigation steps.
							</p>
						</div>
						<img
							className='w-full'
					...
					<div className='relative'>
						...
						<div className='lg:hidden absolute z-50 w-full h-full left-0 bottom-0 p-[22px] flex flex-col justify-end '>
							...
							<p className='text-white text-[10px] font-medium opacity-80 pb-[13px]'>
								...
								adipiscing elit. Ultrices lorem non feugiat
								egestas amet.
							</p>
