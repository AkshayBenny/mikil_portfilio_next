	...
	return (
		<div className='max-w-[1500px] mx-auto lg:grid grid-cols-2 items-center gap-x-8 px-[40px] lg:px-16 col-span-1'>
			...
			<div className='lg:max-w-[620px] '>
				...
				<p className='text-[20px] opacity-[48%] pb-8 leading-[33px]'>
					{desc}
				</p>
				<Link href={link}>
					<button className='flex items-center justify-center gap-[17px] border border-light-gray rounded-lg px-6 py-[19px] font-bold text-sm lg:text-base text-dark-blue hover:text-white hover:bg-[#120055] transition'>
						<p>View more</p>
